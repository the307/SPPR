...
def prepare_kchng_data(master_df, n, m):
    ...
    return {"Q_kchng_day": Q_kchng_day, "Q_kchng": Q_kchng}
...
# def prepare_rn_vankor_data(master_df, n, prev_days, N, day):

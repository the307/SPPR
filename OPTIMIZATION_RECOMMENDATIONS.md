...
См. файлы в папке `optimization_examples/` (если созданы):
- `optimized_data_prep.py` - оптимизированная версия data_prep
- `input_manager.py` - менеджер ввода данных
- `calculate/suzun.py` - пример модульной структуры
